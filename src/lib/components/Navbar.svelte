...
<nav>
    ...
    <section class="options">
        <button title="Toggle Dark Mode" on:click={() => (darkMode = !darkMode)}>
            {#if !darkMode}
                <svg xmlns="http://www.w3.org/2000/svg" transition:fade={{ duration: 200 }} width="16" height="16" fill="black" viewBox="0 0 16 16">
